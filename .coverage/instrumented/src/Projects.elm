...
displayLinks links =
    let
        _ =
            Coverage.track "Projects" 11
    in
    case links of
        [] ->
            let
                _ =
                    Coverage.track "Projects" 7
            in
            htmlNil
